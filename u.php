...
<title>PHP探针-UPUPW环境集成包NGINX经典专用版</title>
<meta name="keywords" content="PHP探针,PHP组件,UPUPW,UPUPW集成包,nginx,php,eAccelerator,ionCube,memcache,Zend Optimizer,SendMail" />
<meta name="description" content="UPUPW环境集成包NGINX经典专用版PHP探针可检测ionCube,eAccelerator,memcache,Zend Optimizer,SendMail等PHP组件." />
...
<tr>
  <td colspan="4" class="ft">UPUPW NGINX版<?=PHP_SAPI .' PHP/'.PHP_VERSION?>系列全部包含以上组件，默认未开启的请根据需要在UPUPW面板PHP功能选项里配置</td>
  </tr>
</table>
